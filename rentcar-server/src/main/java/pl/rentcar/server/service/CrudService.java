...
public interface CrudService<ADD, PROJECTION> {
    ...
    List<String> getVisibleFieldsForTable(String tableId);

    void saveTableColumnsConfig(String tableId, List<ModelTableColumnConfig> tableColumnsConfig);

    List<ModelTableColumnConfig> getTableColumnsConfig(String tableId);
}
